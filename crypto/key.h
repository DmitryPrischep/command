...
private:
    ...
    std::vector<byte_t> shift_word(const std::vector<byte_t> word);
    std::vector<byte_t> sub_word(const std::vector<byte_t> word);
    ByteArray get_encrypt_key(std::vector<byte_t> pass);
